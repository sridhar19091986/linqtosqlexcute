...
//	mTime=psbyfilenum.Where (e=>e.FileNum ==psbyfilenum.Key).Select(e=>e.PacketTime.Value.AddHours(8)).Min (),
	mTime=psbyfilenum.Where (e=>e.FileNum ==psbyfilenum.Key).Min (e=>e.PacketTime.Value.AddHours(-8)),
//	mName="Paging_TypePS_AnyUplinkPDU",
 	mMessage= psbyfilenum.Where (e=>e.FileNum ==psbyfilenum.Key).Sum (e=>e.Paging_Type_PS),   
	mRepeat= psbyfilenum.Where (e=>e.FileNum ==psbyfilenum.Key).Sum (e=>e.PS_Paging_Repeat),
	mRespone= psbyfilenum.Where (e=>e.FileNum ==psbyfilenum.Key).Sum (e=>e.Any_Uplink_PDU ),
	mRepeatSucc= (psbyfilenum.Where (e=>e.FileNum ==psbyfilenum.Key).Sum (e=>e.PS_Paging_Repeat)+0.0)/psbyfilenum.Where (e=>e.FileNum ==psbyfilenum.Key).Sum (e=>e.Any_Uplink_PDU ),
	mResponeSucc= (psbyfilenum.Where (e=>e.FileNum ==psbyfilenum.Key).Sum (e=>e.Any_Uplink_PDU )+0.0)/psbyfilenum.Where (e=>e.FileNum ==psbyfilenum.Key).Sum (e=>e.Paging_Type_PS),
	mDelay=psbyfilenum.Where (e=>e.FileNum ==psbyfilenum.Key).Average (e =>e.Any_Uplink_PDU_delayFirst)
	};
	ps.Dump ();