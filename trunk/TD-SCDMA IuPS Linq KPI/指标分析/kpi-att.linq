...
.Where (e=>e.DumpFor =="EndFlowByFlowDesigner").Where(e=>e.Attach_Complete_delayFirst<20000)
	group p by  p.ID_REQ!=null  into ps
	select new {
	mKey=ps.Key ,
	mATTRequest=ps.Sum (e=>e.Attach_Request),
	mATTcomplete=ps.Sum(e=>e.Attach_Complete),
	...
	a.OrderByDescending(e=>e.mATTDelay).Dump();