...
var ps= from p in Gb_Get1xes
	...
	//	mTime=psbyfilenum.Where (e=>e.FileNum ==psbyfilenum.Key).Select(e=>e.PacketTime.Value.AddHours(8)).Min (),
		mTime=psbyfilenum.Where (e=>e.FileNum ==psbyfilenum.Key).Select(e=>e.PacketTime.Value.AddHours(-8)).Min (),
	mName="WSP_Get_Acknowledge",
	mMessage= psbyfilenum.Where (e=>e.FileNum ==psbyfilenum.Key).Where (e=>e.Acknowledge!=null).Select(e=>e.Acknowledge).Sum (),
	mSuccess= (psbyfilenum.Where (e=>e.FileNum ==psbyfilenum.Key).Where (e=>e.Acknowledge !=null).Select(e=>e.Acknowledge).Sum ()+0.0)/psbyfilenum.Where (e=>e.FileNum ==psbyfilenum.Key).Select(e=>e.Get1x).Sum (),
