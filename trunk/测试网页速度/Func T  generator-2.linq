...
int startAt = 1;
int nextValue = 5;
IEnumerable<int> sequence = CreateSequence(2,()=> startAt += nextValue);
	sequence.Dump ();
double total = 1;
total = Sum(sequence, total, (sum, num) => sum * num);
total.Dump ();}
// Define other methods and classes here
public static TResult Sum<T, TResult>(IEnumerable<T>sequence,TResult total,Func<T,TResult, TResult> accumulator){
