...
/* Table: ciBVCI                                      */
/*==============================================================*/
create table dbo.ciBVCI (
   ciBVCI_id    numeric              identity(1, 1),
   fileNum int null,
   lacCi  nvarchar(50)         collate Chinese_PRC_CI_AS null,
   bvci  nvarchar(50)         collate Chinese_PRC_CI_AS null,
   ciCoverType  nvarchar(50)         collate Chinese_PRC_CI_AS null,
   ciCoverClass  nvarchar(5)         collate Chinese_PRC_CI_AS null,
   constraint PK_ciBVCI_id primary key nonclustered (ciBVCI_id )
		 on "PRIMARY"
)
on "PRIMARY"
go