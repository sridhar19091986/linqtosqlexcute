...
var ps= from p in Gb_Connect2xes
	...
	mMessage=psbyfilenum.Where (e=>e.!=null).Sum(e=>e.Acknowledge),
	mSuccess= (psbyfilenum.Where (e=>e.Acknowledge!=null).Sum(e=>e.Acknowledge)+0.0)/psbyfilenum.Sum(e=>e.Connect1x),
