...
//	mTime=psbyfilenum.Where (e=>e.FileNum ==psbyfilenum.Key).Select(e=>e.PacketTime.Value.AddHours(8)).Min (),
		mTime=psbyfilenum.Where (e=>e.FileNum ==psbyfilenum.Key).Select(e=>e.PacketTime.Value.AddHours(-8)).Min (),
	mName="HTTP_Post_Response",
	mMessage= psbyfilenum.Where (e=>e.FileNum ==psbyfilenum.Key).Where (e=>e.Response!=null).Select(e=>e.Response ).Sum (),
	mSuccess= (psbyfilenum.Where (e=>e.FileNum ==psbyfilenum.Key).Where (e=>e.Response!=null).Select(e=>e.Response ).Sum ()+0.0)/psbyfilenum.Where (e=>e.FileNum ==psbyfilenum.Key).Select(e=>e.Post2x).Sum (),
